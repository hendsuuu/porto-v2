...
export default function AboutSection() {
  return (
    <section className="w-full min-h-screen flex bg-[#526D82]">
        ...
        <div className="w-full flex p-4">
          ...
          <div className="w-1/2 p-4">
            <p className="text-2xl text-justify text-white">
              ...
              unde dolores amet soluta nihil corporis voluptate cum tempore quas
              ullam, blanditiis fugit culpa officia, delectus rem cumque.

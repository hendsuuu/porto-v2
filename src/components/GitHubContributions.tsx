...
export default function GitHubContributions() {
  ...
  return (
    <section className="text-white w-full">
      ...
      <p className="text-sm text-white/70 mb-4">{total} contributions in the last year</p>

      {/* Month labels row */}
      <div className="flex items-center">
        {/* spacer untuk area label hari */}
      ...
      <div className="mt-2 flex gap-2">
        {/* Day labels (posisi sejajar baris tertentu) */}
        <div className="w-10 relative" style={{ height: 7 * (CELL + GAP) - GAP }}>
          {/* GitHub biasanya tampil Mon/Wed/Fri */}
          <span className="absolute text-xs text-white/60" style={{ top: 1 * (CELL + GAP) - 2 }}>
            Mon
          </span>
          <span className="absolute text-xs text-white/60" style={{ top: 3 * (CELL + GAP) - 2 }}>
            Wed
          </span>
          <span className="absolute text-xs text-white/60" style={{ top: 5 * (CELL + GAP) - 2 }}>
            Fri
          </span>
        </div>
